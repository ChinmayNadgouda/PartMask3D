...
input_data2 = load_data_from_npy('/home/gokul/ConceptGraphs/concept-graphs/conceptgraph/Mask3D/data/processed/scannet200/test/0b4b9151-53fb-4b89-91d4-9551efff9953.npy') 
...
masks_scores = main(cfg, input_data2[:,:3], input_data2[:,3:6], input_data2[:,6:9], '_test_test_')
print(masks_scores)
